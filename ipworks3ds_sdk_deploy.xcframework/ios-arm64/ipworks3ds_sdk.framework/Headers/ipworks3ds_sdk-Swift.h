...
SWIFT_CLASS("_TtC14ipworks3ds_sdk18CertEncodedIsEmpty")
@interface CertEncodedIsEmpty : NSObject <UnameThridInstructionPtr>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)oobAppURLIsNameEqual:(NSData * _Null_unspecified)dataPacket;
- (void)publicKeyChallengeTextBox:(NSData * _Null_unspecified)dataPacket;
- (void)getTextFontNameDeviceParameterTest:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)oOBContinuationIndicatorInfoDict:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)cancelCReqCornerRadius:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)setCornerRadiusPorts:(NSString * _Null_unspecified)message;
@end
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk40LinkeditCmdNameThreeDSServerAuthResponse")
@interface LinkeditCmdNameThreeDSServerAuthResponse : NSObject
+ (void)toFileContinueAfterFailure;
+ (void)sDKUtilsTestDynamicSymbolTableCmd;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
